...
export const metadata = {
  title: "Explore Tokens — WAGMII",
  description:
    "Discover every token on the WAGMII launchpad. Filter by trending, new, or top gainers. Search, sort, and find your next trade.",
};
