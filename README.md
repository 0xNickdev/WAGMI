...
Frontend for **Sketch**, a simple ERC20 launchpad on **Robinhood Chain**.
...
Built from `Sketch_Launchpad_V1_Requirements.docx`.
...
| `NEXT_PUBLIC_API_URL` | Sketch indexer/REST API |
